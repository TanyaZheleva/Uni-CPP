...
int main()
{
	...
	q288.AddOption("Communication", -1);
	q288.AddOption("Software", -1);
	q288.AddOption("Tranzaction", -1);
	q288.AddOption("Physical", -1);
	q288.AddOption("Data Link", 1);
	exam.push_back(q28);
	...
	exa.AddOption("Printer < RS232 < Disc", -1);
	m.push_back(q53);
